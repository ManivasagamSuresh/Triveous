...
const handleSignin = ()=>{
  ...
  return (
    <div className={`login bg-cover bg-center  h-screen w-screen flex items-center justify-center bgCustom text-center`} style={{ backgroundImage: `url(${bg})` }}>
      ...
      <h1 className="text-2xl md:text-3xl font-semibold">Sign up to News App</h1>
          <form className="flex flex-col gap-4 my-4 h-full" onSubmit={formik.handleSubmit}> 
          <input type="text"  placeholder="Name" onChange={formik.handleChange} value={formik.values.name} name="name" className="border px-2"/>  
          ...
          <button type="submit" className="bg-gray-600 text-white border-none p-2 rounded-lg">Sign Up</button>
          </form>
